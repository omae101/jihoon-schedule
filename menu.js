...
(function () {
  ...
  holder.innerHTML = ''
    ...
    +   '<div class="hbo-hrow"><span class="hbo-hic">👨‍👩‍👧</span><div><b>여러 자녀 함께 관리 (부모-자녀)</b><p>메뉴 맨 위 <b>자녀</b> 칸에서 <b>"+ 자녀 추가"</b>로 아이를 등록하고, 이름 칩을 누르면 그 자녀로 <b>전환</b>돼요. 자녀마다 일정·할 일·성적이 <b>따로 저장</b>돼 한 폰에서 여러 아이를 관리할 수 있어요. <br>※ <b>엄마폰과 자녀폰을 실시간으로 잇는 연동</b>(서로 다른 두 기기가 같은 일정 보기)은 <b>준비 중</b>이에요. 곧 추가할게요.</p></div></div>'
