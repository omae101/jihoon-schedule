...
(function () {
  ...
  holder.innerHTML = ''
    ...
    +   '<a class="hbo-item" href="routine.html"><span class="hbo-ic">🌱</span><span>우리 아이 루틴 <small style="color:#9CA1AB;font-weight:600;">(집중·정리)</small></span></a>'
    +   '<a class="hbo-item" href="rewards.html"><span class="hbo-ic">🎁</span><span>보상 <small style="color:#9CA1AB;font-weight:600;">(포인트·뱃지)</small></span></a>'
    ...
    +   '<div class="hbo-divider"></div>'
    +   '<a class="hbo-item" href="pair.html" style="color:#3B4CB8;font-weight:700;"><span class="hbo-ic">🔗</span><span>자녀 연동 <small style="color:#9CA1AB;font-weight:600;">(엄마폰↔아이폰)</small></span></a>'
    +   '<div class="hbo-divider"></div>'
    ...
    +   '<div class="hbo-hrow"><span class="hbo-hic">👨‍👩‍👧</span><div><b>여러 자녀 함께 관리 (부모-자녀)</b><p>메뉴 맨 위 <b>자녀</b> 칸에서 <b>"+ 자녀 추가"</b>로 아이를 등록하고, 이름 칩을 누르면 그 자녀로 <b>전환</b>돼요. 자녀마다 일정·할 일·성적이 <b>따로 저장</b>돼 한 폰에서 여러 아이를 관리할 수 있어요. <br>※ <b>엄마폰과 아이폰을 실시간으로 잇는 연동</b>(서로 다른 두 기기가 같은 일정 보기)은 메뉴 <b>🔗 자녀 연동</b>에서 코드로 이을 수 있어요.</p></div></div>'
